...
def sub0603(idx1):
    def sub0603_1(answer):
        ...
        if answer == u'숯':
            ...
            print(
                '*벡터 데이터로 변환*, (sentence {}, feature {})'.format(X.shape[0], X.shape[1])
            )
    ...
    def sub0603_7(answer):
        ...
        for ans in text :
            if answer == ans:
                grade = 2
                print("sub0603_7번의 답 : [정답]")
                return grade
            else:
                print("sub0603_7번의 답 : [오답]")
        return grade
    ...
    print("1번 {}점, 2번 {}점, 3번 {}점, 4번 {}점, 5번 {}점, 6번 {}점, 7번 {}점".format(ans1,ans2,ans3,ans4,ans5,ans6,ans7))
